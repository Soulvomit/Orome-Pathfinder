	...
	private:
		...
		.fSortedInsert:
			...
			.next_open_node:
				...
				cmp rbx, [r10 + Node.FCost]		;compare adjecents f-cost with topframes f-cost
				...
				cmp rdx, [r10 + Node.HCost]		;compare adjecents h-cost with topfames h-cost
