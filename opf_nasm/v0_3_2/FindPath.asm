...
FindPath:
	...
	cmp rax, 1					;if IncludeDiagonals == true
	jz .includediagonals		;jmp to include digonals
		mov ax, 4				;else, mov ax, 4 
		jmp .ignorediagonals	;and ignore diagonals
	.includediagonals:
		mov ax, 8				;mov ax, 8
	.ignorediagonals:
	push word ax				;store ax on stack
